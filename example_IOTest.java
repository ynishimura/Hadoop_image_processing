...
public class IOTest extends Configured implements Tool {
        ...
        public int run(String[] args) throws Exception {
                ...
                job.setJarByClass(IOTest.class);
                job.setJobName("IOTest");
        ...
        public static void main(String[] args) throws Exception {
                int res = ToolRunner.run(new Configuration(), new IOTest(), args);
                System.exit(res);
        }
}
